...
public class Player : MonoBehaviour, ITeamInterface
{
    ...
    void Start()// được gọi một lần duy nhất khi GameObject chứa script đó được kích hoạt trong scene
    {
        if (moveStick == null) Debug.LogError("moveStick chưa được gán trong Inspector!");
        if (aimStick == null) Debug.LogError("aimStick chưa được gán trong Inspector!");
    ...
    {
        //Phayer is move but not aiming, and cameraController exists
